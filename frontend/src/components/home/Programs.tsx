...
const features = [
  ...
  },
  {
    ...
    icon: FileCheck,
    desc: "Teachers can record daily class attendance in seconds. Students receive real-time visibility into attendance records.",
    tags: ["Roll Call", "Attendance Registers", "Instant Sync"],
    color: "text-[#0F766E]",
  ...
  },
  {
    ...
    icon: Users,
    desc: "Manage complete profiles for students, teachers, and admins. Search by name, filter by role, and update details easily.",
